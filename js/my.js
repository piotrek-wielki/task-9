...
const fullName = "Piotrek Wielki";
const phone = "66-66";
const hobbies = "killing it... in IT:D";
const email = "allegeditkiller@gmail.com";
const websiteLink = "www.allegeditkiller.com";
const websiteTitle = "Killer IT Stories";
